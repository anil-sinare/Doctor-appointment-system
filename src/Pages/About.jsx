...
import about_img from "../assets/assets_frontend/about_image.png"
    ...
    <div>
      ...
      <div className='  pt-10  font-lg text-xl    text-gray-600'>
        ...
        <div className='flex flex-col md:flex-row mb-20'>
          <div className='border border-gray-300 px-10 mb:px-16 py-8 md:py-16 text-[15px] hover:bg-blue-500 hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'> 
            <b>EFFICIENCY: </b>
